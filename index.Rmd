...
`r round(100*(170-162)/162,0)` percent too big.

```{r plot, echo=FALSE, fig.height=5}
age <- 35:95
men <- 220 - age
women <- 206 - 0.88 * age
plot(age,men,type="l", col="blue", main="Predicted Peak Heart Rate",
     xlab="Age in years", ylab="Heart rate (beats/min)")
lines(age,women,col="orangered")
```
